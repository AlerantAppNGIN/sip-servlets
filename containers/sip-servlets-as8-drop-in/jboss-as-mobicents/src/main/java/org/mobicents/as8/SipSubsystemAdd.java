...
import org.mobicents.as8.deployment.UndertowSipDeploymentNotificationProcessor;
    ...
    protected void performBoottime(OperationContext context, ModelNode operation, ModelNode model,
        ...
        context.addStep(new AbstractDeploymentChainStep() {
            ...
            protected void execute(DeploymentProcessorTarget processorTarget) {
                ...
                processorTarget.addDeploymentProcessor(SipExtension.SUBSYSTEM_NAME, Phase.INSTALL,
                        Phase.INSTALL_WAR_DEPLOYMENT + 2, new UndertowSipDeploymentNotificationProcessor());
